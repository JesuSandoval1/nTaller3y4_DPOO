...
public class Aeropuerto
{
	...
	public Aeropuerto(String nombre, String codigo, String nombreCiudad, double latitud, double longitud, Set<String> codigosUtilizados) throws AeropuertoDuplicadoException {
		this.nombre = nombre;
		this.codigo = codigo;
